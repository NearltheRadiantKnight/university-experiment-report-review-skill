...
This skill uses the AgentSkills `SKILL.md` standard and a companion `AGENTS.md`. Agents must resolve paths relative to the skill directory rather than assuming a Codex-only location.
