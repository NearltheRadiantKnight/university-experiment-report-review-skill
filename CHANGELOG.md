...
- Mark AI-generated content with explicit labels, distinct fonts, and category colors while leaving original runs untouched.
...
- Keep all model reasoning local to the current agent session with no external API.
